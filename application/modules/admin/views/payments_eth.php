...
<?php 
    $count = 1;
    if(isset($eth_transactions) && is_array($eth_transactions) && count($eth_transactions)>0 ) { 
        foreach ($eth_transactions as $key => $value) { ?>
        <tr>
          <td><?php echo $count; ?></th>
          <td><a target="_blank" href="https://etherscan.io/tx/<?php echo $value['txid']; ?>"><?php echo substr($value['txid'],0,10); ?></a></td>
